...
// using fetch to get data from the API
    ...
    //basic error handling for unrecognized cities, error inputs, etc
        .catch(error => {
            alert("An error occured, please try again entering a CITY NAME only please, thanks for your time!")
        });
}